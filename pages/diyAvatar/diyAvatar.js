...
Page({
  ...
  data: {
    ...
    cornerFrameUrl:['','','',''],
    outerFrames:[
      {frameId:'0',frameSrc:'../../sources/img/none.png'},
      {frameId:'1',frameSrc:'../../sources/img/avatar_frame_out_1.png'},
      {frameId:'2',frameSrc:'../../sources/img/avatar_frame_out_2.png'},
      {frameId:'3',frameSrc:'../../sources/img/avatar_frame_out_3.png'}
    ],
    innerFrames:[
      {frameId:'10',frameSrc:'../../sources/img/none.png'},
      {frameId:'11',frameSrc:'../../sources/img/avatar_frame_out_2.png'},
      {frameId:'12',frameSrc:'../../sources/img/avatar_frame_out_3.png'}
    ],
    cornerFrames:[
      // 用十位数字表示方位：0左上，1左下，2右上，3右下
      {frameId:'100',frameSrc:'../../sources/img/none.png'},
      {frameId:'101',frameSrc:'../../sources/img/ava1.png'},
      {frameId:'112',frameSrc:'../../sources/img/ava2.png'},
      {frameId:'123',frameSrc:'../../sources/img/ava3.png'},
      {frameId:'134',frameSrc:'../../sources/img/ava4.png'},
    ],
  },
